...
public class SpUtils {
    ...
    public static final String AUTO_INSTALL = "AUTO_INSATLL";
    public static final String AUTO_OPEN_HONGBOA = "AUTO_OPEN";
    public static final String SMS_AUTO_SNED_NUM = "SMS_AUTO_SNED_NUM";
